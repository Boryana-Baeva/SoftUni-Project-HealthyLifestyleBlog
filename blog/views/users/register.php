...
<div class="register-block">
    <form method="post">
        ...
        <div id="password">* Password: <input type="password" name="password" placeholder="Enter password" required/>
        </div>
        <div id="confirm">* Confirm: <input type="password" name="password_confirm" placeholder="Confirm password"
                                            required/></div>
